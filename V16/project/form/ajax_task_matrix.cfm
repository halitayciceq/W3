    ...
    <cfswitch expression="#attributes.action#">
        ...
        <cfcase value="get">
            ...
            <cfif qTemplate.recordcount>
                <cfset response.template = {
                    ...
                    instance_id: listFindNoCase(qTemplate.columnList, "INSTANCE_ID") ? qTemplate.INSTANCE_ID : 0,
                    calc_percent: listFindNoCase(qTemplate.columnList, "CALC_PERCENT") ? qTemplate.CALC_PERCENT : 0,
                    ws_set_id: listFindNoCase(qTemplate.columnList, "WS_SET_ID") ? qTemplate.WS_SET_ID : 0
                }>
            </cfif>
        ...
        <cfcase value="save">
            ...
            <cfif qResult.recordcount>
                <cfset response.instance_id = listFindNoCase(qResult.columnList, "INSTANCE_ID") ? qResult.INSTANCE_ID : 0>
                <cfset response.calc_percent = listFindNoCase(qResult.columnList, "CALC_PERCENT") ? qResult.CALC_PERCENT : 0>
